...
namespace nothinbutdotnetprep.specs
{
    ...
    public class when_searching_for_movies : concern_for_searching_and_sorting
    {
        ...
        It should_be_able_to_find_all_movies_published_after_a_certain_year = () =>
        {
            ...
            var results =
                sut.all_movies().all_items_matching(Where<Movie>.has_an(x => x.date_published.Year).greater_than(2004));
        ...
        It should_be_able_to_find_all_movies_published_between_a_certain_range_of_years = () =>
        {
            ...
            var results =
                sut.all_movies().all_items_matching(Where<Movie>.has_an(x => x.date_published.Year).between(1982, 2003));
